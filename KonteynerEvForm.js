...
export default function KonteynerEvForm() {
  ...
  return (
    <div style={{ padding: "2rem" }}>
      ...
      <form>
        <div>
          <label>Ev Alanı (m²)</label>
          <input name="area" type="number" value={formData.area} onChange={handleChange} />
        </div>
        <div>
          <label>Panel Kalınlığı</label>
          <input name="thickness" value={formData.thickness} onChange={handleChange} />
        </div>
        <div>
          <label>Renk</label>
        ...
        <div>
          ...
          <input name="insulation" value={formData.insulation} onChange={handleChange} />
        </div>
        <div>
